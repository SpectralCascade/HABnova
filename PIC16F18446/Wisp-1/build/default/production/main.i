...
# 541 "main.c"
            ...
            case ',':
                ...
                if (doParse)
                {
                    ...
                    {
                        index = Insert(messages[dataFieldType > PUBX_NAVSTAT ? 1 : 0], ',', index, 70);
                    }
                    dataIndex = 0;
                }
                break;
            ...
            if (!skip && doParse)
            {
                ...
                {
                case PUBX_DATA_TYPE:
                    Insert(data_type, byte, dataIndex, 7);
                    break;
                case PUBX_TIME:
                    if (dataIndex < 6)
                    {
                        ...
                        index = Insert(messages[0], byte, index, 70);
                    }
                    break;
                case PUBX_LAT:
                    if (dataIndex == 0)
                ...
                case PUBX_NS:
                    ...
                    {
                        index = Insert(messages[0], '-', signInsertIndex, 70);
                    }
                    break;
                case PUBX_LONG:
                    if (dataIndex == 0)
                ...
                case PUBX_SOG:
                case PUBX_VVEL:
                    index = Insert(messages[1], byte, index, 70);
                    break;
                }
                dataIndex++;
            }
    ...
    if (success)
    {
        ...
        index = InsertString(messages[1], data_type, index, 70);
    }
